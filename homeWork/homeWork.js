...
/*
CI – итоговая сумма, которую вы получите на счету (если речь идет о вкладе) или которую вам нужно будет погасить (если речь идет о кредите)
principal – изначальная сумма вклада или займа
